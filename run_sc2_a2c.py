...
from sc2atari.policy import FullyConvPolicy
from sc2atari.sc2toatari import SC2AtariEnv
from absl import flags
from absl.flags import FLAGS

from sc2atari.policy import LstmPolicy
...
def main():
    flags.DEFINE_string("map_name", "DefeatZerglingsAndBanelings", "Name of the map")
